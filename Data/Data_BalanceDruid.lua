...
WTBT_Data["Druid"]["Balance"] = {
    ...
    [3] = {
        Head = {
            { name = "Thunderheart Headguard",             source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "yellow", "meta" },       enchant = nil, itemId = 31040 },
            ...
            { name = "Nordrassil Headpiece",               source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "token", gems = { "yellow", "meta" },       enchant = nil, itemId = 30233 },
        },
        Neck = {
            ...
            { name = "Vindicator's Pendant of Conquest",   source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "yellow" },               enchant = nil, itemId = 33920 },
        },
        Shoulder = {
            { name = "Thunderheart Shoulderpads",          source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "blue", "yellow" },       enchant = nil, itemId = 31049 },
            { name = "Hatefury Mantle",                    source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = { "blue", "yellow" },       enchant = nil, itemId = 30884 },
            { name = "Nordrassil Wrath-Mantle",            source = "Void Reaver — Tempest Keep",               sourceType = "token", gems = { "blue", "yellow" },       enchant = nil, itemId = 30235 },
        },
        Back = {
        ...
        Chest = {
            { name = "Thunderheart Vest",                  source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "blue", "blue", "yellow" }, enchant = nil, itemId = 31043 },
            { name = "Nordrassil Chestpiece",              source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "blue", "blue", "yellow" }, enchant = nil, itemId = 30231 },
        ...
        Wrist = {
            ...
            { name = "Focused Mana Bindings",              source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32270 },
            { name = "Elunite Empowered Bracers",          source = "Essence of Anger — Black Temple",          sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32351 },
        },
        Hands = {
            { name = "Thunderheart Handguards",            source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31035 },
            { name = "Nordrassil Gauntlets",               source = "Leotheras the Blind — Serpentshrine Cavern", sourceType = "token", gems = {},                         enchant = nil, itemId = 30232 },
        ...
        Legs = {
            ...
            { name = "Thunderheart Pants",                 source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 31046 },
            { name = "Leggings of Devastation",            source = "Mother Shahraz — Black Temple",            sourceType = "drop",  gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 32367 },
        },
        Feet = {
            ...
            { name = "Naturewarden's Treads",              source = "Essence of Anger — Black Temple",          sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32352 },
        ...
        MainHand = {
            ...
            { name = "Vengeful Gladiator's Battle Staff",  source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 34540 },
        },
        OffHand = {
        ...
        Relic = {
            { name = "Idol of the Raven Goddess",          source = "Vanquish the Raven God",                   sourceType = "quest", gems = {},                         enchant = nil, itemId = 32387 },
            { name = "Ivory Idol of the Moongoddess",      source = "Grand Warlock Nethekurse — The Shattered Halls", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 27518 },
            { name = "Idol of the Avenger",                source = "News of Victory",                          sourceType = "quest", gems = {},                         enchant = nil, itemId = 31025 },
        },
    },
    -- =========================================================
    -- PHASE 4 — Zul'Aman
