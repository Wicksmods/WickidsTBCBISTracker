...
WTBT_Data["Priest"]["Holy"] = {
    ...
    [3] = {
        Head = {
            { name = "Cowl of Absolution",                 source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "meta", "blue" },         enchant = nil, itemId = 31063 },
            { name = "Cowl of the Avatar",                 source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "token", gems = { "meta", "yellow" },       enchant = nil, itemId = 30152 },
            { name = "Cowl of Benevolence",                source = "Teron Gorefiend — Black Temple",           sourceType = "drop",  gems = { "meta", "blue" },         enchant = nil, itemId = 32329 },
        },
        Neck = {
        ...
        Shoulder = {
            { name = "Mantle of Absolution",               source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "blue", "blue" },         enchant = nil, itemId = 31069 },
            { name = "Mantle of the Avatar",               source = "Void Reaver — Tempest Keep",               sourceType = "token", gems = { "blue", "blue" },         enchant = nil, itemId = 30154 },
            { name = "Swiftheal Mantle",                   source = "Tailoring",                                sourceType = "craft", gems = {},                         enchant = nil, itemId = 32585 },
        },
        Back = {
            { name = "Shroud of the Highborne",            source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32524 },
            { name = "Shroud of Forgiveness",              source = "Gurtogg Bloodboil — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32337 },
            { name = "Sunshower Light Cloak",              source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29989 },
        },
        Chest = {
            { name = "Vestments of Absolution",            source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "blue", "yellow", "blue" }, enchant = nil, itemId = 31066 },
            { name = "Vestments of the Avatar",            source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "blue", "yellow", "blue" }, enchant = nil, itemId = 30150 },
            { name = "Primal Mooncloth Robe",              source = "Tailoring (Mooncloth)",                    sourceType = "craft", gems = { "yellow", "blue" },       enchant = nil, itemId = 21875 },
        },
        Wrist = {
            { name = "Swiftheal Wraps",                    source = "Tailoring",                                sourceType = "craft", gems = {},                         enchant = nil, itemId = 32584 },
            { name = "Bracers of Martyrdom",               source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = { "blue" },                 enchant = nil, itemId = 30871 },
            { name = "Wristbands of Divine Influence",     source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32513 },
        },
        Hands = {
            { name = "Gloves of Absolution",               source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 31060 },
            { name = "Gloves of Unfailing Faith",          source = "Essence of Anger — Black Temple",          sourceType = "drop",  gems = { "red", "blue" },          enchant = nil, itemId = 32353 },
            { name = "Gloves of the Avatar",               source = "Leotheras the Blind — Serpentshrine Cavern", sourceType = "token", gems = {},                         enchant = nil, itemId = 30151 },
        },
        Waist = {
            { name = "Angelista's Sash",                   source = "Kaz'rogal — Hyjal Summit",                 sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30895 },
            { name = "Belt of Divine Guidance",            source = "High Nethermancer Zerevor — Black Temple", sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32519 },
            { name = "Belt of the Long Road",              source = "Tailoring",                                sourceType = "craft", gems = { "blue", "yellow" },       enchant = nil, itemId = 30036 },
        },
        Legs = {
            { name = "Leggings of Eternity",               source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = { "blue", "blue", "blue" }, enchant = nil, itemId = 30912 },
            { name = "Breeches of Absolution",             source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31068 },
            { name = "Breeches of the Avatar",             source = "Fathom-Lord Karathress — Serpentshrine Cavern", sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 30153 },
        },
        Feet = {
            { name = "Boots of the Divine Light",          source = "Trash — Hyjal Summit",                     sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32609 },
            { name = "Soul-Strider Boots",                 source = "Fathom-Lord Karathress — Serpentshrine Cavern", sourceType = "drop",  gems = { "red", "blue" },          enchant = nil, itemId = 30100 },
            { name = "Archbishop's Slippers",              source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30885 },
        },
        Ring1 = {
        ...
        Ring2 = {
            ...
            { name = "Violet Signet of the Grand Restorer", source = "Eminence Among the Violet Eye",            sourceType = "quest", gems = {},                         enchant = nil, itemId = 29290 },
            { name = "Ring of Flowing Light",              source = "Doom Lord Kazzak — World Boss",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30736 },
        },
        Trinket1 = {
            { name = "Memento of Tyrande",                 source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32496 },
            { name = "Essence of the Martyr",              source = "G'eras — Badges of Justice",               sourceType = "badge", gems = {},                         enchant = nil, itemId = 29376 },
            { name = "Darkmoon Card: Blue Dragon",         source = "Darkmoon Faire — Beast Deck",              sourceType = "quest", gems = {},                         enchant = nil, itemId = 19288 },
        },
        Trinket2 = {
            { name = "Eye of Gruul",                       source = "Gruul the Dragonkiller — Gruul's Lair",    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28823 },
            { name = "Earring of Soulful Meditation",      source = "The Lurker Below — Serpentshrine Cavern",  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30665 },
        ...
        MainHand = {
            ...
            { name = "Apostle of Argus",                   source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30908 },
        },
        OffHand = {
        ...
        Relic = {
            ...
            { name = "Luminescent Rod of the Naaru",       source = "Morogrim Tidewalker — Serpentshrine Cavern", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30080 },
            { name = "Blue Diamond Witchwand",             source = "Opera Event — Karazhan",                   sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28588 },
        },
    },
    -- =========================================================
