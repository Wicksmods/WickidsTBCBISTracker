...
WTBT_Data["Priest"]["Shadow"] = {
    ...
    [3] = {
        Head = {
            { name = "Hood of Absolution",                 source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "meta", "blue" },         enchant = nil, itemId = 31064 },
        ...
        Neck = {
            ...
            { name = "Chain of the Twilight Owl",          source = "Jewelcrafting",                            sourceType = "craft", gems = {},                         enchant = nil, itemId = 24121 },
            { name = "Eye of the Night",                   source = "Jewelcrafting",                            sourceType = "craft", gems = {},                         enchant = nil, itemId = 24116 },
        },
        Shoulder = {
            { name = "Shoulderpads of Absolution",         source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "yellow", "blue" },       enchant = nil, itemId = 31070 },
        ...
        Chest = {
            { name = "Shroud of Absolution",               source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 31065 },
            ...
            { name = "Shroud of the Avatar",               source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 30159 },
        },
        Wrist = {
        ...
        Hands = {
            { name = "Handguards of Absolution",           source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31061 },
        ...
        Waist = {
            ...
            { name = "Lurker's Cord of Shadow Wrath",      source = "Hyakiss the Lurker — Karazhan",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30675 },
        },
        Legs = {
            ...
            { name = "Leggings of Absolution",             source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31067 },
        },
        Feet = {
            ...
            { name = "Frozen Shadoweave Boots",            source = "Tailoring (Shadoweave)",                   sourceType = "craft", gems = { "yellow", "blue" },       enchant = nil, itemId = 21870 },
            { name = "Glider's Foot-Wraps of Shadow Wrath", source = "Shadikith the Glider — Karazhan",          sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30680 },
        },
        Ring1 = {
