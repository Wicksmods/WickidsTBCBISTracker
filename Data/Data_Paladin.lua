...
WTBT_Data["Paladin"]["Holy"] = {
    ...
    [3] = {
        Head = {
            { name = "Lightbringer Greathelm",             source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "yellow", "meta" },       enchant = nil, itemId = 30988 },
            { name = "Crown of Empowered Fate",            source = "Essence of Anger — Black Temple",          sourceType = "drop",  gems = { "meta", "blue" },         enchant = nil, itemId = 32354 },
            { name = "Helm of Soothing Currents",          source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = { "blue", "meta" },         enchant = nil, itemId = 32241 },
        },
        Neck = {
            { name = "Nadina's Pendant of Purity",         source = "Mother Shahraz — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32370 },
            { name = "Lord Sanguinar's Claim",             source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30018 },
            { name = "Archaic Charm of Presence",          source = "Doomwalker — World Boss",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30726 },
        },
        Shoulder = {
            { name = "Lightbringer Pauldrons",             source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "yellow", "blue" },       enchant = nil, itemId = 30996 },
            { name = "Glimmering Steel Mantle",            source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = { "blue", "yellow" },       enchant = nil, itemId = 30878 },
            { name = "Crystalforge Pauldrons",             source = "Void Reaver — Tempest Keep",               sourceType = "token", gems = { "yellow", "yellow" },     enchant = nil, itemId = 30138 },
        },
        Back = {
            { name = "Shroud of the Highborne",            source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32524 },
            { name = "Shroud of the Final Stand",          source = "Trash — Black Temple",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 34012 },
            { name = "Sunshower Light Cloak",              source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29989 },
        },
        Chest = {
            { name = "Lightbringer Chestpiece",            source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "blue", "yellow", "yellow" }, enchant = nil, itemId = 30992 },
            { name = "Savior's Grasp",                     source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30904 },
            { name = "Crystalforge Chestpiece",            source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "blue", "yellow", "yellow" }, enchant = nil, itemId = 30134 },
        },
        Wrist = {
            { name = "Blessed Adamantite Bracers",         source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = { "yellow" },               enchant = nil, itemId = 30862 },
            { name = "Howling Wind Bracers",               source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = { "blue" },                 enchant = nil, itemId = 30869 },
            { name = "Dawnsteel Bracers",                  source = "Blacksmithing",                            sourceType = "craft", gems = {},                         enchant = nil, itemId = 32571 },
        },
        Hands = {
            { name = "Glorious Gauntlets of Crestfall",    source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 30112 },
            { name = "Lightbringer Gloves",                source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 30983 },
            { name = "Worldstorm Gauntlets",               source = "High Astromancer Solarian — Tempest Keep", sourceType = "drop",  gems = { "blue", "yellow" },       enchant = nil, itemId = 29976 },
        },
        Waist = {
            { name = "Girdle of Hope",                     source = "Azgalor — Hyjal Summit",                   sourceType = "drop",  gems = { "yellow", "yellow" },     enchant = nil, itemId = 30897 },
            { name = "Girdle of Fallen Stars",             source = "Trash — Tempest Keep",                     sourceType = "drop",  gems = { "yellow", "yellow" },     enchant = nil, itemId = 30030 },
            { name = "Girdle of the Righteous Path",       source = "High Astromancer Solarian — Tempest Keep", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29965 },
        },
        Legs = {
            { name = "Lightbringer Leggings",              source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 30994 },
            { name = "Leggings of Eternity",               source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = { "blue", "blue", "blue" }, enchant = nil, itemId = 30912 },
            { name = "Kilt of Immortal Nature",            source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = { "blue", "yellow", "blue" }, enchant = nil, itemId = 32271 },
        },
        Feet = {
            { name = "Pearl Inlaid Boots",                 source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32243 },
            { name = "Boots of Courage Unending",          source = "Trash — Serpentshrine Cavern",             sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30027 },
            { name = "Boots of the Divine Light",          source = "Trash — Hyjal Summit",                     sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32609 },
        },
        Ring1 = {
        ...
        Ring2 = {
            { name = "Ring of Calming Waves",              source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32238 },
            { name = "Coral Band of the Revived",          source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30110 },
            { name = "Naaru Lightwarden's Band",           source = "Magtheridon — Magtheridon's Lair",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28790 },
        },
        Trinket1 = {
        ...
        Trinket2 = {
            { name = "Lower City Prayerbook",              source = "Lower City — Revered",                     sourceType = "rep",   gems = {},                         enchant = nil, itemId = 30841 },
            { name = "Direbrew Hops",                      source = "Coren Direbrew — Blackrock Depths",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 38288 },
        },
        MainHand = {
            { name = "Crystal Spire of Karabor",           source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32500 },
            { name = "Vengeful Gladiator's Salvation",     source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33743 },
            { name = "Hammer of Atonement",                source = "Kaz'rogal — Hyjal Summit",                 sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30918 },
        },
        OffHand = {
            { name = "Felstone Bulwark",                   source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32255 },
            { name = "Bastion of Light",                   source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = { "red" },                  enchant = nil, itemId = 30882 },
            { name = "Scepter of Purification",            source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30911 },
        },
        Relic = {
            { name = "Libram of Souls Redeemed",           source = "Opera Event — Karazhan",                   sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28592 },
            { name = "Libram of Absolute Truth",           source = "The Lurker Below — Serpentshrine Cavern",  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30063 },
            { name = "Libram of the Lightbringer",         source = "Commander Sarannis — The Botanica",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28296 },
        },
    },
    [4] = {
        Head = {
...
WTBT_Data["Paladin"]["Protection"] = {
    ...
    [3] = {
        Head = {
            ...
            { name = "Lightbringer Faceguard",             source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "yellow", "meta" },       enchant = nil, itemId = 30987 },
            { name = "Crystalforge Faceguard",             source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "token", gems = { "red", "meta" },          enchant = nil, itemId = 30125 },
        },
        Neck = {
            { name = "Pendant of Titans",                  source = "Essence of Anger — Black Temple",          sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32362 },
            { name = "The Darkener's Grasp",               source = "Kael'thas and the Verdant Sphere",         sourceType = "quest", gems = {},                         enchant = nil, itemId = 30007 },
            { name = "Vindicator's Pendant of Dominance",  source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "yellow" },               enchant = nil, itemId = 33921 },
        },
        Shoulder = {
            { name = "Lightbringer Shoulderguards",        source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "yellow", "yellow" },     enchant = nil, itemId = 30998 },
            { name = "Pauldrons of Abyssal Fury",          source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32250 },
            { name = "Justicar Shoulderguards",            source = "High King Maulgar — Gruul's Lair",         sourceType = "token", gems = { "blue", "yellow" },       enchant = nil, itemId = 29070 },
        },
        Back = {
            { name = "Pepe's Shroud of Pacification",      source = "Trash — Hyjal Summit",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 34010 },
            { name = "Phoenix-Wing Cloak",                 source = "Al'ar — Tempest Keep",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29925 },
            { name = "Ruby Drape of the Mysticant",        source = "Prince Malchezaar — Karazhan",             sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28766 },
        },
        Chest = {
            { name = "Lightbringer Chestguard",            source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "red", "red", "yellow" }, enchant = nil, itemId = 30991 },
            { name = "Glory of the Defender",              source = "Azgalor — Hyjal Summit",                   sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30896 },
            { name = "Vengeful Gladiator's Lamellar Chestpiece", source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "red", "red", "yellow" }, enchant = nil, itemId = 33695 },
        },
        Wrist = {
            { name = "The Seeker's Wristguards",           source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32279 },
            { name = "Eternium Shell Bracers",             source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32232 },
            { name = "Vindicator's Lamellar Bracers",      source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "yellow" },               enchant = nil, itemId = 33889 },
        },
        Hands = {
            { name = "Lightbringer Handguards",            source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "red" },                  enchant = nil, itemId = 30985 },
            { name = "Royal Gauntlets of Silvermoon",      source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 29998 },
            { name = "Crystalforge Handguards",            source = "Leotheras the Blind — Serpentshrine Cavern", sourceType = "token", gems = {},                         enchant = nil, itemId = 30124 },
        },
        Waist = {
            { name = "Girdle of Mighty Resolve",           source = "Gurtogg Bloodboil — Black Temple",         sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32342 },
            { name = "Girdle of Stability",                source = "Gurtogg Bloodboil — Black Temple",         sourceType = "drop",  gems = { "red", "yellow" },        enchant = nil, itemId = 32333 },
            { name = "Girdle of the Invulnerable",         source = "Leotheras the Blind — Serpentshrine Cavern", sourceType = "drop",  gems = { "red", "blue" },          enchant = nil, itemId = 30096 },
        },
        Legs = {
            { name = "Lightbringer Legguards",             source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 30995 },
            { name = "Praetorian's Legguards",             source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = { "yellow", "yellow", "red" }, enchant = nil, itemId = 32263 },
            { name = "Vengeful Gladiator's Lamellar Legguards", source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33698 },
        },
        Feet = {
            { name = "Tide-stomper's Greaves",             source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = { "red", "yellow" },        enchant = nil, itemId = 32245 },
            { name = "Boots of the Resilient",             source = "High Astromancer Solarian — Tempest Keep", sourceType = "drop",  gems = { "red", "yellow" },        enchant = nil, itemId = 32267 },
            { name = "Blue Suede Shoes",                   source = "Kaz'rogal — Hyjal Summit",                 sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30894 },
        },
        Ring1 = {
            { name = "Ring of Sundered Souls",             source = "Morogrim Tidewalker — Serpentshrine Cavern", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30083 },
            { name = "Ashyen's Gift",                      source = "Cenarion Expedition — Exalted",            sourceType = "rep",   gems = {},                         enchant = nil, itemId = 29172 },
            { name = "Violet Signet of the Great Protector", source = "Eminence Among the Violet Eye",            sourceType = "quest", gems = {},                         enchant = nil, itemId = 29279 },
        },
        Ring2 = {
            { name = "Band of the Abyssal Lord",           source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32261 },
            { name = "Band of Crimson Fury",               source = "The Fall of Magtheridon",                  sourceType = "quest", gems = {},                         enchant = nil, itemId = 28793 },
            { name = "Seventh Ring of the Tirisfalen",     source = "Trash — Tempest Keep",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30028 },
        },
        Trinket1 = {
            { name = "Darkmoon Card: Vengeance",           source = "Darkmoon Faire — Furies Deck",             sourceType = "quest", gems = {},                         enchant = nil, itemId = 31858 },
            { name = "Brightbrew Charm",                   source = "Coren Direbrew — Blackrock Depths",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 37127 },
            { name = "Goblin Rocket Launcher",             source = "Engineering (Goblin)",                     sourceType = "craft", gems = {},                         enchant = nil, itemId = 23836 },
        },
        Trinket2 = {
            { name = "Darkmoon Card: Madness",             source = "Darkmoon Faire — Lunacy Deck",             sourceType = "quest", gems = {},                         enchant = nil, itemId = 31859 },
            { name = "Balebrew Charm",                     source = "Coren Direbrew — Blackrock Depths",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 37128 },
            { name = "Gnomish Poultryizer",                source = "Engineering (Gnomish)",                    sourceType = "craft", gems = {},                         enchant = nil, itemId = 23835 },
        },
        MainHand = {
            { name = "Tempest of Chaos",                   source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30910 },
            { name = "Vengeful Gladiator's Gavel",         source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33687 },
            { name = "Fang of the Leviathan",              source = "Leotheras the Blind — Serpentshrine Cavern", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30095 },
        },
        OffHand = {
            { name = "Bulwark of Azzinoth",                source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32375 },
            { name = "Antonidas's Aegis of Rapt Concentration", source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30909 },
            { name = "Kaz'rogal's Hardened Heart",         source = "Kaz'rogal — Hyjal Summit",                 sourceType = "drop",  gems = { "yellow" },               enchant = nil, itemId = 30889 },
        },
        Relic = {
            { name = "Libram of Repentance",               source = "G'eras — Badges of Justice",               sourceType = "badge", gems = {},                         enchant = nil, itemId = 29388 },
            { name = "Tome of the Lightbringer",           source = "Mother Shahraz — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32368 },
            { name = "Libram of the Eternal Rest",         source = "Darkweaver Syth — Sethekk Halls",          sourceType = "drop",  gems = {},                         enchant = nil, itemId = 27917 },
        },
    },
    [4] = {
        Head = {
...
WTBT_Data["Paladin"]["Retribution"] = {
    ...
    [3] = {
        Head = {
            ...
            { name = "Forest Prowler's Helm",              source = "The Illidari Council — Black Temple",      sourceType = "drop",  gems = { "red", "meta" },          enchant = nil, itemId = 32376 },
            { name = "Helm of the Illidari Shatterer",     source = "The Illidari Council — Black Temple",      sourceType = "drop",  gems = { "meta", "yellow" },       enchant = nil, itemId = 32373 },
        },
        Neck = {
            { name = "Choker of Endless Nightmares",       source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32260 },
            { name = "Pendant of the Perilous",            source = "Trash — Serpentshrine Cavern",             sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30022 },
            { name = "Telonicus's Pendant of Mayhem",      source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30017 },
        },
        Shoulder = {
            { name = "Shoulderpads of the Stranger",       source = "Hydross the Unstable — Serpentshrine Cavern", sourceType = "drop",  gems = { "red" },                  enchant = nil, itemId = 30055 },
        ...
        Back = {
            ...
            { name = "Cloak of Darkness",                  source = "Leatherworking",                           sourceType = "craft", gems = { "blue" },                 enchant = nil, itemId = 33122 },
            { name = "Razor-Scale Battlecloak",            source = "Morogrim Tidewalker — Serpentshrine Cavern", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30098 },
        },
        Chest = {
            { name = "Lightbringer Breastplate",           source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "red", "yellow", "blue" }, enchant = nil, itemId = 30990 },
            { name = "Bulwark of the Ancient Kings",       source = "Blacksmithing",                            sourceType = "craft", gems = { "blue", "yellow", "yellow" }, enchant = nil, itemId = 28485 },
        ...
        Wrist = {
            ...
            { name = "Swiftsteel Bracers",                 source = "Blacksmithing",                            sourceType = "craft", gems = {},                         enchant = nil, itemId = 32568 },
            { name = "Furious Shackles",                   source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = { "yellow" },               enchant = nil, itemId = 30861 },
        },
        Hands = {
        ...
        Waist = {
            ...
            { name = "Don Alejandro's Money Belt",         source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = { "red", "yellow" },        enchant = nil, itemId = 30879 },
            { name = "Shadow-walker's Cord",               source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32265 },
        },
        Legs = {
            { name = "Bow-stitched Leggings",              source = "Azgalor — Hyjal Summit",                   sourceType = "drop",  gems = { "red", "yellow", "blue" }, enchant = nil, itemId = 30900 },
            { name = "Leggings of Divine Retribution",     source = "Gurtogg Bloodboil — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32341 },
            { name = "Lightbringer Greaves",               source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "red" },                  enchant = nil, itemId = 30993 },
        },
        Feet = {
            { name = "Shadowmaster's Boots",               source = "Mother Shahraz — Black Temple",            sourceType = "drop",  gems = { "red", "yellow" },        enchant = nil, itemId = 32366 },
            { name = "Dreadboots of the Legion",           source = "Essence of Anger — Black Temple",          sourceType = "drop",  gems = { "yellow", "yellow" },     enchant = nil, itemId = 32345 },
        ...
        Ring2 = {
            ...
            { name = "Band of Devastation",                source = "Trash — Black Temple",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32526 },
            { name = "Ancestral Ring of Conquest",         source = "The Lurker Below — Serpentshrine Cavern",  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30061 },
        },
        Trinket1 = {
            { name = "Dragonspine Trophy",                 source = "Gruul the Dragonkiller — Gruul's Lair",    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28830 },
            { name = "Abacus of Violent Odds",             source = "Pathaleon the Calculator — The Mechanar",  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28288 },
            { name = "Darkmoon Card: Crusade",             source = "Darkmoon Faire — Blessings Deck",          sourceType = "quest", gems = {},                         enchant = nil, itemId = 31856 },
        },
        Trinket2 = {
            { name = "Bloodlust Brooch",                   source = "G'eras — Badges of Justice",               sourceType = "badge", gems = {},                         enchant = nil, itemId = 29383 },
            { name = "Mark of the Champion",               source = "The Fall of Kel'Thuzad",                   sourceType = "quest", gems = {},                         enchant = nil, itemId = 23206 },
        },
        MainHand = {
            ...
            { name = "Vengeful Gladiator's Greatsword",    source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33688 },
        },
        Relic = {
            { name = "Libram of Avengement",               source = "The Maker — Heroic Blood Furnace",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 27484 },
            { name = "Libram of Righteous Power",          source = "News of Victory",                          sourceType = "quest", gems = {},                         enchant = nil, itemId = 31033 },
            { name = "Libram of Fervor",                   source = "World Drop",                               sourceType = "drop",  gems = {},                         enchant = nil, itemId = 23203 },
        },
    },
    [4] = {
        Head = {
