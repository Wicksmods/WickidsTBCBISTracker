...
local TANK_WARRIOR_ENCHANTS = {
    ...
    { slot = "Back",     name = "Enchant Cloak — Titanweave",        stat = "+16 Defense Rating",
      mats = { {name="Large Prismatic Shard", count=4}, {name="Arcane Dust", count=4} } },
    { slot = "Chest",    name = "Enchant Chest — Exceptional Health", stat = "+150 Health",
      mats = { {name="Large Prismatic Shard", count=6}, {name="Arcane Dust", count=6} } },
    { slot = "Wrist",    name = "Enchant Bracer — Major Defense",    stat = "+12 Defense Rating",
      mats = { {name="Large Prismatic Shard", count=2}, {name="Arcane Dust", count=8} } },
    { slot = "Hands",    name = "Enchant Gloves — Stone Skin",       stat = "+10 Armor per sec",
      mats = { {name="Large Prismatic Shard", count=3}, {name="Arcane Dust", count=4} } },
    ...
    { slot = "Feet",     name = "Enchant Boots — Fortitude",         stat = "+12 Stamina",
      mats = { {name="Large Prismatic Shard", count=3}, {name="Arcane Dust", count=8} } },
    { slot = "MainHand", name = "Enchant Weapon — Major Agility",    stat = "+35 Agility",
      mats = { {name="Large Prismatic Shard", count=8}, {name="Arcane Dust", count=8} } },
    { slot = "OffHand",  name = "Enchant Shield — Tough Shield",     stat = "+18 Block Value",
      mats = { {name="Large Prismatic Shard", count=2}, {name="Arcane Dust", count=4} } },
}
...
local MELEE_DPS_WARRIOR_ENCHANTS = {
    ...
    { slot = "Wrist",    name = "Enchant Bracer — Brawn",            stat = "+12 Strength",
      mats = { {name="Large Prismatic Shard", count=4}, {name="Arcane Dust", count=6} } },
    ...
    { slot = "Feet",     name = "Enchant Boots — Dexterity",         stat = "+12 Agility",
      mats = { {name="Large Prismatic Shard", count=4}, {name="Arcane Dust", count=8} } },
    { slot = "MainHand", name = "Enchant Weapon — Mongoose",         stat = "+120 Agility, +2% Haste proc",
      mats = { {name="Large Prismatic Shard", count=10}, {name="Arcane Dust", count=10}, {name="Greater Planar Essence", count=6} } },
...
local CASTER_DPS_ENCHANTS = {
    ...
    { slot = "Wrist",    name = "Enchant Bracer — Spellpower",       stat = "+15 Spell Power",
      mats = { {name="Large Prismatic Shard", count=6}, {name="Arcane Dust", count=10} } },
    ...
    { slot = "Feet",     name = "Enchant Boots — Boar's Speed",      stat = "+9 Stamina, Minor Speed",
      mats = { {name="Large Prismatic Shard", count=8}, {name="Arcane Dust", count=12} } },
    { slot = "MainHand", name = "Enchant Weapon — Spellsurge",       stat = "Chance to restore 300 mana on cast",
      mats = { {name="Large Prismatic Shard", count=8}, {name="Greater Planar Essence", count=4}, {name="Arcane Dust", count=10} } },
}
...
local HEALER_ENCHANTS = {
    ...
    { slot = "Wrist",    name = "Enchant Bracer — Restore Mana Prime", stat = "+6 MP5",
      mats = { {name="Large Prismatic Shard", count=4}, {name="Greater Planar Essence", count=4} } },
