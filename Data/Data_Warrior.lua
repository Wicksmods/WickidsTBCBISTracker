...
WTBT_Data["Warrior"]["Arms"] = {
    ...
    [3] = {
        Head = {
            { name = "Onslaught Battle-Helm",              source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "meta", "red" },          enchant = nil, itemId = 30972 },
        ...
        Shoulder = {
            { name = "Onslaught Shoulderblades",           source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "yellow", "blue" },       enchant = nil, itemId = 30979 },
            ...
            { name = "Ripfiend Shoulderplates",            source = "Doom Lord Kazzak — World Boss",            sourceType = "drop",  gems = { "yellow", "yellow" },     enchant = nil, itemId = 30740 },
        },
        Back = {
        ...
        Chest = {
            { name = "Onslaught Breastplate",              source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "red", "blue", "blue" },  enchant = nil, itemId = 30975 },
            { name = "Midnight Chestguard",                source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = { "blue", "red", "yellow" }, enchant = nil, itemId = 30905 },
            { name = "Vengeful Gladiator's Plate Chestpiece", source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "red", "red", "yellow" }, enchant = nil, itemId = 33728 },
        },
        Wrist = {
            ...
            { name = "Bladespire Warbands",                source = "High King Maulgar — Gruul's Lair",         sourceType = "drop",  gems = { "blue", "red" },          enchant = nil, itemId = 28795 },
        },
        Hands = {
            { name = "Onslaught Gauntlets",                source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "red" },                  enchant = nil, itemId = 30969 },
            { name = "Grips of Silent Justice",            source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = { "red", "red" },           enchant = nil, itemId = 32278 },
            { name = "Gloves of the Searing Grip",         source = "Al'ar — Tempest Keep",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29947 },
        },
        Waist = {
        ...
        Legs = {
            ...
            { name = "Onslaught Greaves",                  source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 30977 },
        ...
        Ring1 = {
            ...
            { name = "Vindicator's Band of Triumph",       source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33919 },
        },
        Ring2 = {
        ...
        Trinket2 = {
            ...
            { name = "Tsunami Talisman",                   source = "Leotheras the Blind — Serpentshrine Cavern", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30627 },
        ...
        MainHand = {
            ...
            { name = "Soul Cleaver",                       source = "Teron Gorefiend — Black Temple",           sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32348 },
        ...
        Relic = {
            ...
            { name = "Serpent Spine Longbow",              source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30105 },
        },
    },
    [4] = {
        Head = {
...
WTBT_Data["Warrior"]["Protection"] = {
    ...
    [3] = {
        Head = {
            ...
            { name = "Vengeful Gladiator's Plate Helm",    source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "meta", "yellow" },       enchant = nil, itemId = 33730 },
            { name = "Destroyer Greathelm",                source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "token", gems = { "meta", "red" },          enchant = nil, itemId = 30115 },
        },
        Neck = {
            { name = "Pendant of Titans",                  source = "Essence of Anger — Black Temple",          sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32362 },
            { name = "Vindicator's Pendant of Triumph",    source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "yellow" },               enchant = nil, itemId = 33923 },
            { name = "Frayed Tether of the Drowned",       source = "Fathom-Lord Karathress — Serpentshrine Cavern", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30099 },
        },
        Shoulder = {
            { name = "Onslaught Shoulderblades",           source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "yellow", "blue" },       enchant = nil, itemId = 30979 },
            { name = "Vengeful Gladiator's Plate Shoulders", source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "red", "yellow" },        enchant = nil, itemId = 33732 },
            { name = "Destroyer Shoulderblades",           source = "Void Reaver — Tempest Keep",               sourceType = "token", gems = { "yellow", "blue" },       enchant = nil, itemId = 30122 },
        },
        Back = {
        ...
        Chest = {
            { name = "Onslaught Breastplate",              source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "red", "blue", "blue" },  enchant = nil, itemId = 30975 },
            { name = "Vengeful Gladiator's Plate Chestpiece", source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "red", "red", "yellow" }, enchant = nil, itemId = 33728 },
            { name = "Destroyer Chestguard",               source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "blue", "yellow", "red" }, enchant = nil, itemId = 30113 },
        },
        Wrist = {
            { name = "Vindicator's Plate Bracers",         source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "yellow" },               enchant = nil, itemId = 33813 },
            { name = "Bracers of Eradication",             source = "The Lurker Below — Serpentshrine Cavern",  sourceType = "drop",  gems = { "blue" },                 enchant = nil, itemId = 30057 },
            { name = "Furious Shackles",                   source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = { "yellow" },               enchant = nil, itemId = 30861 },
        },
        Hands = {
            { name = "Gauntlets of Enforcement",           source = "Teron Gorefiend — Black Temple",           sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32280 },
            { name = "Gloves of the Searing Grip",         source = "Al'ar — Tempest Keep",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29947 },
            { name = "Pillager's Gauntlets",               source = "Trash — Black Temple",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32608 },
        },
        Waist = {
            { name = "Belt of One-Hundred Deaths",         source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "drop",  gems = { "red", "blue" },          enchant = nil, itemId = 30106 },
            { name = "Girdle of Stability",                source = "Gurtogg Bloodboil — Black Temple",         sourceType = "drop",  gems = { "red", "yellow" },        enchant = nil, itemId = 32333 },
            { name = "Red Belt of Battle",                 source = "Blacksmithing",                            sourceType = "craft", gems = { "blue", "yellow" },       enchant = nil, itemId = 30032 },
        },
        Legs = {
            { name = "Onslaught Greaves",                  source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 30977 },
            { name = "Vengeful Gladiator's Plate Legguards", source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33731 },
            { name = "Legguards of Endless Rage",          source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30903 },
        },
        Feet = {
            { name = "Dreadboots of the Legion",           source = "Essence of Anger — Black Temple",          sourceType = "drop",  gems = { "yellow", "yellow" },     enchant = nil, itemId = 32345 },
            { name = "Vindicator's Plate Greaves",         source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33812 },
            { name = "Myrmidon's Treads",                  source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = { "yellow", "red" },        enchant = nil, itemId = 32268 },
        },
        Ring1 = {
            { name = "Shapeshifter's Signet",              source = "Lower City — Exalted",                     sourceType = "rep",   gems = {},                         enchant = nil, itemId = 30834 },
            { name = "Band of the Eternal Champion",       source = "Scale of the Sands — Exalted",             sourceType = "rep",   gems = {},                         enchant = nil, itemId = 29301 },
        ...
        Ring2 = {
            ...
            { name = "Band of Eternity",                   source = "Scale of the Sands — Revered",             sourceType = "rep",   gems = {},                         enchant = nil, itemId = 29296 },
            { name = "Vindicator's Band of Triumph",       source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33919 },
        },
        Trinket1 = {
            ...
            { name = "Commander's Badge",                  source = "Hail, Commander!",                         sourceType = "quest", gems = {},                         enchant = nil, itemId = 32864 },
        },
        Trinket2 = {
        ...
        MainHand = {
            { name = "The Brutalizer",                     source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32254 },
            { name = "Blade of Savagery",                  source = "Mother Shahraz — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32369 },
            { name = "The Unbreakable Will",               source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30874 },
        },
        OffHand = {
            ...
            { name = "Vengeful Gladiator's Shield Wall",   source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33755 },
        },
        Relic = {
            { name = "Legionkiller",                       source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32253 },
            { name = "Gyro-Balanced Khorium Destroyer",    source = "Engineering",                              sourceType = "craft", gems = { "yellow" },               enchant = nil, itemId = 32756 },
