...
WTBT_Data["Shaman"]["Restoration"] = {
    ...
    [3] = {
        Head = {
            { name = "Skyshatter Helmet",                  source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "meta", "yellow" },       enchant = nil, itemId = 31012 },
            ...
            { name = "Cataclysm Headguard",                source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "token", gems = { "meta", "yellow" },       enchant = nil, itemId = 30166 },
        },
        Neck = {
            ...
            { name = "Vindicator's Pendant of Salvation",  source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "yellow" },               enchant = nil, itemId = 33922 },
        },
        Shoulder = {
            { name = "Skyshatter Shoulderpads",            source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "blue", "yellow" },       enchant = nil, itemId = 31022 },
            { name = "Living Earth Shoulders",             source = "Leatherworking",                           sourceType = "craft", gems = {},                         enchant = nil, itemId = 32579 },
            { name = "Cataclysm Shoulderguards",           source = "Void Reaver — Tempest Keep",               sourceType = "token", gems = { "blue", "blue" },         enchant = nil, itemId = 30168 },
        },
        Back = {
        ...
        Chest = {
            { name = "Skyshatter Chestguard",              source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "blue", "blue", "yellow" }, enchant = nil, itemId = 31016 },
            { name = "Cataclysm Chestguard",               source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "blue", "blue", "yellow" }, enchant = nil, itemId = 30164 },
            { name = "Golden Links of Restoration",        source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30887 },
        },
        Wrist = {
            { name = "Living Earth Bindings",              source = "Leatherworking",                           sourceType = "craft", gems = {},                         enchant = nil, itemId = 32577 },
            { name = "Swiftheal Wraps",                    source = "Tailoring",                                sourceType = "craft", gems = {},                         enchant = nil, itemId = 32584 },
            { name = "Bracers of Renewed Life",            source = "Leatherworking",                           sourceType = "craft", gems = {},                         enchant = nil, itemId = 32582 },
        },
        Hands = {
            { name = "Botanist's Gloves of Growth",        source = "Teron Gorefiend — Black Temple",           sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32328 },
            { name = "Spiritwalker Gauntlets",             source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32275 },
        ...
        Legs = {
            { name = "Skyshatter Leggings",                source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "red" },                  enchant = nil, itemId = 31019 },
        ...
        Feet = {
            ...
            { name = "Gold-Leaf Wildboots",                source = "Doom Lord Kazzak — World Boss",            sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 30737 },
            { name = "Orca-Hide Boots",                    source = "Leotheras the Blind — Serpentshrine Cavern", sourceType = "drop",  gems = { "blue", "blue" },         enchant = nil, itemId = 30092 },
        },
        Ring1 = {
        ...
        Relic = {
            { name = "Totem of Healing Rains",             source = "Maiden of Virtue — Karazhan",              sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28523 },
            { name = "Totem of Spontaneous Regrowth",      source = "Mennu the Betrayer — Heroic Slave Pens",   sourceType = "drop",  gems = {},                         enchant = nil, itemId = 27544 },
            { name = "Totem of the Plains",                source = "The Ultimate Bloodsport",                  sourceType = "quest", gems = {},                         enchant = nil, itemId = 25645 },
        },
    },
    [4] = {
        Head = {
...
WTBT_Data["Shaman"]["Enhancement"] = {
    ...
    [3] = {
        Head = {
            ...
            { name = "Skyshatter Cover",                   source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "meta", "yellow" },       enchant = nil, itemId = 31015 },
        },
        Neck = {
            { name = "Choker of Endless Nightmares",       source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32260 },
            { name = "Choker of Serrated Blades",          source = "Trash — Black Temple",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32591 },
        ...
        Shoulder = {
            { name = "Shoulders of Lightning Reflexes",    source = "Leatherworking",                           sourceType = "craft", gems = {},                         enchant = nil, itemId = 32575 },
        ...
        Back = {
            ...
            { name = "Vengeance Wrap",                     source = "Tailoring",                                sourceType = "craft", gems = { "red" },                  enchant = nil, itemId = 24259 },
        },
        Chest = {
            ...
            { name = "Bloodsea Brigand's Vest",            source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 30101 },
        },
        Wrist = {
        ...
        Hands = {
            { name = "Fists of Mukoa",                     source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32234 },
        ...
        Waist = {
            ...
            { name = "Boneweave Girdle",                   source = "Essence of Anger — Black Temple",          sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32346 },
        },
        Legs = {
            ...
            { name = "Skyshatter Pants",                   source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 31021 },
        },
        Feet = {
            ...
            { name = "Quickstrider Moccasins",             source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = { "red", "yellow" },        enchant = nil, itemId = 30880 },
        },
        Ring1 = {
        ...
        Trinket1 = {
            ...
            { name = "Ashtongue Talisman of Vision",       source = "Ashtongue Deathsworn — Exalted",           sourceType = "rep",   gems = {},                         enchant = nil, itemId = 32491 },
            { name = "Empty Mug of Direbrew",              source = "Coren Direbrew — Blackrock Depths",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 38287 },
        },
        Trinket2 = {
            ...
            { name = "Slayer's Crest",                     source = "Sapphiron — Naxxramas",                    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 23041 },
        },
        MainHand = {
            { name = "Syphon of the Nathrezim",            source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32262 },
            { name = "Vengeful Gladiator's Cleaver",       source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33669 },
            { name = "Rising Tide",                        source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32236 },
        },
        OffHand = {
            { name = "Claw of Molten Fury",                source = "Trash — Hyjal Summit",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32946 },
            { name = "Talon of the Phoenix",               source = "Al'ar — Tempest Keep",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32944 },
            { name = "Rod of the Sun King",                source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29996 },
        },
        Relic = {
            { name = "Totem of the Astral Winds",          source = "Heroic Mana-Tombs",                        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 27815 },
            { name = "Stonebreaker's Totem",               source = "Spirits of Auchindoun",                    sourceType = "quest", gems = {},                         enchant = nil, itemId = 27984 },
        },
    },
    [4] = {
        Head = {
...
WTBT_Data["Shaman"]["Elemental"] = {
    ...
    [3] = {
        Head = {
            { name = "Skyshatter Headguard",               source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "meta", "blue" },         enchant = nil, itemId = 31014 },
            { name = "Cowl of the Illidari High Lord",     source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = { "meta", "blue" },         enchant = nil, itemId = 32525 },
            { name = "Cyclone Faceguard",                  source = "Prince Malchezaar — Karazhan",             sourceType = "token", gems = { "meta", "yellow" },       enchant = nil, itemId = 29035 },
        },
        Neck = {
            { name = "The Sun King's Talisman",            source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30015 },
            { name = "Translucent Spellthread Necklace",   source = "Reliquary of Souls — Black Temple",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32349 },
            { name = "Adornment of Stolen Souls",          source = "Prince Malchezaar — Karazhan",             sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28762 },
        },
        Shoulder = {
            { name = "Skyshatter Mantle",                  source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "blue", "yellow" },       enchant = nil, itemId = 31023 },
            { name = "Mantle of Nimble Thought",           source = "Tailoring",                                sourceType = "craft", gems = {},                         enchant = nil, itemId = 32587 },
            { name = "Hatefury Mantle",                    source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = { "blue", "yellow" },       enchant = nil, itemId = 30884 },
        },
        Back = {
            { name = "Shroud of the Highborne",            source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32524 },
            { name = "Cloak of the Illidari Council",      source = "The Illidari Council — Black Temple",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32331 },
            { name = "Brute Cloak of the Ogre-Magi",       source = "High King Maulgar — Gruul's Lair",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28797 },
        },
        Chest = {
            { name = "Skyshatter Breastplate",             source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "blue", "yellow", "yellow" }, enchant = nil, itemId = 31017 },
            { name = "Chestguard of Relentless Storms",    source = "Trash — Black Temple",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32592 },
            { name = "Cataclysm Chestpiece",               source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "blue", "yellow", "yellow" }, enchant = nil, itemId = 30169 },
        },
        Wrist = {
            { name = "Bracers of Nimble Thought",          source = "Tailoring",                                sourceType = "craft", gems = {},                         enchant = nil, itemId = 32586 },
            { name = "Cuffs of Devastation",               source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = { "yellow" },               enchant = nil, itemId = 30870 },
            { name = "Bands of the Coming Storm",          source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32259 },
        },
        Hands = {
            { name = "Skyshatter Gauntlets",               source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31008 },
            { name = "Botanist's Gloves of Growth",        source = "Teron Gorefiend — Black Temple",           sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32328 },
            { name = "Spiritwalker Gauntlets",             source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32275 },
        },
        Waist = {
            ...
            { name = "Belt of Blasting",                   source = "Tailoring",                                sourceType = "craft", gems = { "blue", "yellow" },       enchant = nil, itemId = 30038 },
        },
        Legs = {
            { name = "Leggings of Channeled Elements",     source = "Kaz'rogal — Hyjal Summit",                 sourceType = "drop",  gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 30916 },
            { name = "Skyshatter Legguards",               source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31020 },
            { name = "Cataclysm Leggings",                 source = "Fathom-Lord Karathress — Serpentshrine Cavern", sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 30172 },
        },
        Feet = {
            { name = "Slippers of the Seacaller",          source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32239 },
            { name = "Naturewarden's Treads",              source = "Reliquary of Souls — Black Temple",        sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32352 },
            { name = "Boots of Oceanic Fury",              source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32242 },
        },
        Ring1 = {
        ...
        Ring2 = {
            ...
            { name = "Ring of Unrelenting Storms",         source = "Trash — Karazhan",                         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30667 },
            { name = "Dreamcrystal Band",                  source = "Zone Drop — Blade's Edge Mountains",       sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32664 },
        },
        Trinket1 = {
            { name = "The Lightning Capacitor",            source = "Terestian Illhoof — Karazhan",             sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28785 },
            { name = "Mark of the Champion",               source = "The Fall of Kel'Thuzad",                   sourceType = "quest", gems = {},                         enchant = nil, itemId = 23207 },
            { name = "Dark Iron Smoking Pipe",             source = "Coren Direbrew — Blackrock Depths",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 38290 },
        },
        Trinket2 = {
        ...
        OffHand = {
            ...
            { name = "Fathomstone",                        source = "Hydross the Unstable — Serpentshrine Cavern", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30049 },
        },
        Relic = {
            { name = "Totem of Ancestral Guidance",        source = "Teron Gorefiend — Black Temple",           sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32330 },
            { name = "Totem of the Void",                  source = "Cache of the Legion — The Mechanar",       sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28248 },
            { name = "Totem of the Pulsing Earth",         source = "G'eras — Badges of Justice",               sourceType = "badge", gems = {},                         enchant = nil, itemId = 29389 },
        },
    },
    [4] = {
        Head = {
