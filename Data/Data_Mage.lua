...
WTBT_Data["Mage"]["Fire"] = {
    [1] = {
        ...
        Shoulder = {
            ...
            { name = "Spaulders of the Torn-heart",       source = "The Curator — Karazhan",             sourceType = "drop",  gems = {},                   enchant = nil, itemId = 28612 },
        },
        Back = {
        ...
        Legs = {
            ...
            { name = "Pantaloons of Repentence",          source = "Opera Event — Karazhan",             sourceType = "drop",  gems = {},                   enchant = nil, itemId = 28594 },
        },
        Feet = {
    ...
    [2] = {
        ...
        Shoulder = {
            { name = "Mantle of the Elven Kings",         source = "Trash — Tempest Keep",               sourceType = "drop",  gems = {},                   enchant = nil, itemId = 30024 },
        ...
        Relic = {
            { name = "Wand of the Forgotten Star",        source = "High Astromancer Solarian — Tempest Keep", sourceType = "drop",  gems = {},                   enchant = nil, itemId = 29982 },
        },
    },
    [3] = {
        Head = {
            ...
            { name = "Cowl of the Tempest",                source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "meta", "yellow" },       enchant = nil, itemId = 31056 },
            { name = "Destruction Holo-gogs",              source = "Engineering",                              sourceType = "craft", gems = { "meta", "blue" },         enchant = nil, itemId = 32494 },
        },
        Neck = {
            { name = "Hellfire-Encased Pendant",           source = "Trash — Black Temple",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32589 },
        ...
        Shoulder = {
            { name = "Mantle of the Tempest",              source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "yellow", "blue" },       enchant = nil, itemId = 31059 },
            { name = "Blood-cursed Shoulderpads",          source = "Gurtogg Bloodboil — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32338 },
        ...
        Chest = {
            { name = "Robes of the Tempest",               source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 31057 },
            { name = "Vestments of the Sea-Witch",         source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "drop",  gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 30107 },
        ...
        Hands = {
            { name = "Gloves of the Tempest",              source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31055 },
            { name = "Handwraps of Flowing Thought",       source = "Attumen the Huntsman — Karazhan",          sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 28507 },
            { name = "Gloves of the Aldor",                source = "The Curator — Karazhan",                   sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29080 },
        },
        Waist = {
            { name = "Belt of Blasting",                   source = "Tailoring",                                sourceType = "craft", gems = { "blue", "yellow" },       enchant = nil, itemId = 30038 },
            { name = "Cord of Screaming Terrors",          source = "The Lurker Below — Serpentshrine Cavern",  sourceType = "drop",  gems = { "yellow", "yellow" },     enchant = nil, itemId = 30064 },
            { name = "Anetheron's Noose",                  source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 30888 },
        },
        Legs = {
            { name = "Leggings of the Tempest",            source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 31058 },
            ...
            { name = "Spellstrike Pants",                  source = "Tailoring",                                sourceType = "craft", gems = { "blue", "yellow", "red" }, enchant = nil, itemId = 24262 },
        },
        Feet = {
            ...
            { name = "Boots of Blasting",                  source = "Tailoring",                                sourceType = "craft", gems = {},                         enchant = nil, itemId = 30037 },
            { name = "Velvet Boots of the Guardian",       source = "The Lurker Below — Serpentshrine Cavern",  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30067 },
        },
        Ring1 = {
            ...
            { name = "Violet Signet of the Archmage",      source = "Path of the Violet Mage",                  sourceType = "quest", gems = {},                         enchant = nil, itemId = 29287 },
        },
        Ring2 = {
        ...
        Trinket2 = {
            { name = "Serpent-Coil Braid",                 source = "Morogrim Tidewalker — Serpentshrine Cavern", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30720 },
        ...
        MainHand = {
            ...
            { name = "Vengeful Gladiator's Spellblade",    source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33763 },
        },
        OffHand = {
            { name = "Chronicle of Dark Secrets",          source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30872 },
            { name = "Blind-Seers Icon",                   source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32361 },
    ...
    [5] = {
        ...
        Relic = {
            { name = "Wand of the Demonsoul",             source = "Trash — Sunwell Plateau",            sourceType = "drop",  gems = {},                   enchant = nil, itemId = 34347 },
        },
    },
}
...
WTBT_Data["Mage"]["Frost"] = {
    ...
    [3] = {
        ...
        Feet = {
            { name = "Slippers of the Seacaller",          source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32239 },
            { name = "Vindicator's Silk Footguards",       source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33914 },
            { name = "Boots of Blasting",                  source = "Tailoring",                                sourceType = "craft", gems = {},                         enchant = nil, itemId = 30037 },
        },
        Ring1 = {
            { name = "Ring of Ancient Knowledge",          source = "Trash — Black Temple",                     sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32527 },
...
WTBT_Data["Mage"]["Arcane"] = {
    ...
    [2] = {
        ...
        Trinket1 = {
            { name = "Serpent-Coil Braid",                source = "Morogrim Tidewalker — SSC",          sourceType = "drop",  gems = {},                   enchant = nil, itemId = 30720 },
        },
        Trinket2 = {
            { name = "Icon of the Silver Crescent",       source = "G'eras — Badges of Justice",         sourceType = "badge", gems = {},                   enchant = nil, itemId = 29370 },
        },
    ...
    [3] = {
        Head = {
            { name = "Cowl of Tirisfal",                   source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "token", gems = { "meta", "yellow" },       enchant = nil, itemId = 30206 },
            { name = "Cowl of the Illidari High Lord",     source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = { "meta", "blue" },         enchant = nil, itemId = 32525 },
            { name = "Cowl of the Tempest",                source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "meta", "yellow" },       enchant = nil, itemId = 31056 },
        },
        Neck = {
        ...
        Shoulder = {
            { name = "Mantle of Tirisfal",                 source = "Void Reaver — Tempest Keep",               sourceType = "token", gems = { "yellow", "blue" },       enchant = nil, itemId = 30210 },
            { name = "Mantle of Nimble Thought",           source = "Tailoring",                                sourceType = "craft", gems = {},                         enchant = nil, itemId = 32587 },
            { name = "Pauldrons of the Aldor",             source = "High King Maulgar — Gruul's Lair",         sourceType = "drop",  gems = { "yellow", "red" },        enchant = nil, itemId = 29079 },
        },
        Back = {
            { name = "Cloak of the Illidari Council",      source = "The Illidari Council — Black Temple",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32331 },
            { name = "Shroud of the Highborne",            source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32524 },
            { name = "Royal Cloak of the Sunstriders",     source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29992 },
        },
        Chest = {
            { name = "Robes of Tirisfal",                  source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 30196 },
            { name = "Robes of the Tempest",               source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 31057 },
            { name = "Vestments of the Aldor",             source = "Magtheridon — Magtheridon's Lair",         sourceType = "drop",  gems = { "yellow", "blue", "blue" }, enchant = nil, itemId = 29077 },
        },
        Wrist = {
            { name = "Cuffs of Devastation",               source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = { "yellow" },               enchant = nil, itemId = 30870 },
            { name = "Bracers of Nimble Thought",          source = "Tailoring",                                sourceType = "craft", gems = {},                         enchant = nil, itemId = 32586 },
            { name = "Vindicator's Silk Cuffs",            source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "yellow" },               enchant = nil, itemId = 33913 },
        },
        Hands = {
            { name = "Gloves of Tirisfal",                 source = "Leotheras the Blind — Serpentshrine Cavern", sourceType = "token", gems = {},                         enchant = nil, itemId = 30205 },
            { name = "Gloves of the Tempest",              source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31055 },
            { name = "Gauntlets of the Sun King",          source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29987 },
        },
        Waist = {
            { name = "Anetheron's Noose",                  source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 30888 },
            { name = "Waistwrap of Infinity",              source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32256 },
        ...
        Legs = {
            { name = "Leggings of the Tempest",            source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 31058 },
            { name = "Leggings of Channeled Elements",     source = "Kaz'rogal — Hyjal Summit",                 sourceType = "drop",  gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 30916 },
            { name = "Leggings of Tirisfal",               source = "Fathom-Lord Karathress — Serpentshrine Cavern", sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 30207 },
        },
        Feet = {
            { name = "Slippers of the Seacaller",          source = "High Warlord Naj'entus — Black Temple",    sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 32239 },
            { name = "Velvet Boots of the Guardian",       source = "The Lurker Below — Serpentshrine Cavern",  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30067 },
        ...
        Trinket2 = {
            { name = "Ashtongue Talisman of Insight",      source = "Ashtongue Deathsworn — Exalted",           sourceType = "rep",   gems = {},                         enchant = nil, itemId = 32488 },
            { name = "Sextant of Unstable Currents",       source = "Fathom-Lord Karathress — Serpentshrine Cavern", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30626 },
            { name = "Dark Iron Smoking Pipe",             source = "Coren Direbrew — Blackrock Depths",        sourceType = "drop",  gems = {},                         enchant = nil, itemId = 38290 },
        },
        MainHand = {
            { name = "Zhar'doom, Greatstaff of the Devourer", source = "Illidan Stormrage — Black Temple",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32374 },
            { name = "Tempest of Chaos",                   source = "Archimonde — Hyjal Summit",                sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30910 },
            { name = "The Nexus Key",                      source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29988 },
        },
        OffHand = {
            { name = "Chronicle of Dark Secrets",          source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30872 },
            { name = "Blind-Seers Icon",                   source = "Shade of Akama — Black Temple",            sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32361 },
            { name = "Talisman of Kalecgos",               source = "G'eras — Badges of Justice",               sourceType = "badge", gems = {},                         enchant = nil, itemId = 29271 },
        },
        Relic = {
            { name = "Eredar Wand of Obliteration",        source = "Magtheridon — Magtheridon's Lair",         sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28783 },
            { name = "Wand of the Forgotten Star",         source = "High Astromancer Solarian — Tempest Keep", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 29982 },
    ...
    [5] = {
        ...
        Chest = {
            { name = "Robes of Ghostly Hatred",           source = "M'uru — Sunwell Plateau",            sourceType = "drop",  gems = {},                   enchant = nil, itemId = 34399 },
            { name = "Sunfire Robe",                      source = "Sunwell Crafting",                   sourceType = "craft", gems = { "red", "red", "yellow" }, enchant = nil, itemId = 34364 },
        },
        Wrist = {
            { name = "Bracers of the Tempest",            source = "Kalecgos — Sunwell Plateau",         sourceType = "drop",  gems = {},                   enchant = nil, itemId = 34447 },
        ...
        Hands = {
            { name = "Gloves of Tyri's Power",            source = "Kil'jaeden — Sunwell Plateau",       sourceType = "drop",  gems = {},                   enchant = nil, itemId = 34406 },
            { name = "Gloves of Tirisfal",                source = "Leotheras the Blind — SSC",          sourceType = "drop",  gems = {},                   enchant = nil, itemId = 30205 },
        },
        Waist = {
            { name = "Belt of the Tempest",               source = "Brutallus — Sunwell Plateau",        sourceType = "drop",  gems = {},                   enchant = nil, itemId = 34557 },
