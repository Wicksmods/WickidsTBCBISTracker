...
WTBT_Data["Warlock"]["Destruction"] = {
    ...
    [3] = {
        Head = {
            { name = "Hood of the Malefic",                source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "meta", "yellow" },       enchant = nil, itemId = 31051 },
        ...
        Shoulder = {
            { name = "Mantle of the Malefic",              source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "blue", "yellow" },       enchant = nil, itemId = 31054 },
        ...
        Chest = {
            ...
            { name = "Robe of the Malefic",                source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "yellow", "yellow", "blue" }, enchant = nil, itemId = 31052 },
        ...
        Hands = {
            { name = "Gloves of the Malefic",              source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31050 },
            { name = "Anger-Spark Gloves",                 source = "Doomwalker — World Boss",                  sourceType = "drop",  gems = { "red", "red" },           enchant = nil, itemId = 30725 },
            { name = "Spellfire Gloves",                   source = "Tailoring (Spellfire)",                    sourceType = "craft", gems = { "yellow", "blue" },       enchant = nil, itemId = 21847 },
        },
        Waist = {
        ...
        Legs = {
            ...
            { name = "Leggings of the Malefic",            source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31053 },
        },
        Feet = {
...
WTBT_Data["Warlock"]["Affliction"] = {
    ...
    [3] = {
        ...
        Hands = {
            { name = "Gloves of the Malefic",              source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "yellow" },               enchant = nil, itemId = 31050 },
            { name = "Anger-Spark Gloves",                 source = "Doomwalker — World Boss",                  sourceType = "drop",  gems = { "red", "red" },           enchant = nil, itemId = 30725 },
            { name = "Soul-Eater's Handwraps",             source = "Magtheridon — Magtheridon's Lair",         sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 28780 },
        },
        Waist = {
            { name = "Belt of Blasting",                   source = "Tailoring",                                sourceType = "craft", gems = { "blue", "yellow" },       enchant = nil, itemId = 30038 },
            { name = "Anetheron's Noose",                  source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = { "yellow", "blue" },       enchant = nil, itemId = 30888 },
