...
WTBT_Data["Druid"]["Feral"] = {
    ...
    [3] = {
        Head = {
            { name = "Wolfshead Helm",                     source = "Leatherworking",                           sourceType = "craft", gems = {},                         enchant = nil, itemId = 8345 },
            ...
            { name = "Vengeful Gladiator's Dragonhide Helm", source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "meta", "yellow" },       enchant = nil, itemId = 33672 },
        },
        Neck = {
        ...
        Shoulder = {
            { name = "Thunderheart Pauldrons",             source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "yellow", "blue" },       enchant = nil, itemId = 31048 },
            { name = "Mantle of Malorne",                  source = "High King Maulgar — Gruul's Lair",         sourceType = "token", gems = { "blue", "blue" },         enchant = nil, itemId = 29100 },
            { name = "Nordrassil Feral-Mantle",            source = "Void Reaver — Tempest Keep",               sourceType = "token", gems = { "yellow", "blue" },       enchant = nil, itemId = 30230 },
        },
        Back = {
        ...
        Chest = {
            ...
            { name = "Thunderheart Chestguard",            source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "blue", "yellow", "red" }, enchant = nil, itemId = 31042 },
            { name = "Breastplate of Malorne",             source = "Magtheridon — Magtheridon's Lair",         sourceType = "token", gems = { "yellow", "blue", "red" }, enchant = nil, itemId = 29096 },
        },
        Wrist = {
            { name = "Insidious Bands",                    source = "Teron Gorefiend — Black Temple",           sourceType = "drop",  gems = { "yellow" },               enchant = nil, itemId = 32324 },
            { name = "Vindicator's Dragonhide Bracers",    source = "Arena — Season 3",                         sourceType = "pvp",   gems = { "red" },                  enchant = nil, itemId = 33881 },
        ...
        Hands = {
            ...
            { name = "Thunderheart Gauntlets",             source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 31034 },
        ...
        Legs = {
            { name = "Thunderheart Leggings",              source = "The Illidari Council — Black Temple",      sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 31044 },
        ...
        Feet = {
            ...
            { name = "Fel Leather Boots",                  source = "Leatherworking",                           sourceType = "craft", gems = { "yellow", "red" },        enchant = nil, itemId = 25686 },
        },
        Ring1 = {
        ...
        Trinket2 = {
            ...
            { name = "Icon of Unyielding Courage",         source = "Keli'dan the Breaker — Heroic Blood Furnace", sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28121 },
        },
        MainHand = {
            { name = "Pillar of Ferocity",                 source = "Anetheron — Hyjal Summit",                 sourceType = "drop",  gems = {},                         enchant = nil, itemId = 30883 },
            { name = "Vengeful Gladiator's Staff",         source = "Arena — Season 3",                         sourceType = "pvp",   gems = {},                         enchant = nil, itemId = 33716 },
            { name = "Terestian's Stranglestaff",          source = "Terestian Illhoof — Karazhan",             sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28658 },
        },
        Relic = {
            { name = "Everbloom Idol",                     source = "G'eras — Badges of Justice",               sourceType = "badge", gems = {},                         enchant = nil, itemId = 29390 },
            { name = "Idol of the White Stag",             source = "Supremus — Black Temple",                  sourceType = "drop",  gems = {},                         enchant = nil, itemId = 32257 },
            { name = "Idol of Feral Shadows",              source = "Zereketh the Unbound — The Arcatraz",      sourceType = "drop",  gems = {},                         enchant = nil, itemId = 28372 },
        },
    },
    -- =========================================================
    -- PHASE 4 — Zul'Aman
