...
WTBT_Data["Druid"]["Restoration"] = {
    ...
    [3] = {
        Head = {
            { name = "Thunderheart Helmet",                source = "Archimonde — Hyjal Summit",                sourceType = "token", gems = { "blue", "meta" },         enchant = nil, itemId = 31037 },
            { name = "Cowl of Benevolence",                source = "Teron Gorefiend — Black Temple",           sourceType = "drop",  gems = { "meta", "blue" },         enchant = nil, itemId = 32329 },
            { name = "Nordrassil Headguard",               source = "Lady Vashj — Serpentshrine Cavern",        sourceType = "token", gems = { "yellow", "meta" },       enchant = nil, itemId = 30219 },
        },
        Neck = {
        ...
        Shoulder = {
            { name = "Thunderheart Spaulders",             source = "Mother Shahraz — Black Temple",            sourceType = "token", gems = { "blue", "blue" },         enchant = nil, itemId = 31047 },
            { name = "Shoulderpads of Renewed Life",       source = "Leatherworking",                           sourceType = "craft", gems = {},                         enchant = nil, itemId = 32583 },
        ...
        Chest = {
            { name = "Thunderheart Tunic",                 source = "Illidan Stormrage — Black Temple",         sourceType = "token", gems = { "yellow", "blue", "blue" }, enchant = nil, itemId = 31041 },
            { name = "Nordrassil Chestguard",              source = "Kael'thas Sunstrider — Tempest Keep",      sourceType = "token", gems = { "blue", "blue", "blue" }, enchant = nil, itemId = 30216 },
        ...
        Wrist = {
            ...
            { name = "Rejuvenating Bracers",               source = "Rage Winterchill — Hyjal Summit",          sourceType = "drop",  gems = { "blue" },                 enchant = nil, itemId = 30868 },
        },
        Hands = {
            ...
            { name = "Thunderheart Gloves",                source = "Azgalor — Hyjal Summit",                   sourceType = "token", gems = { "blue" },                 enchant = nil, itemId = 31032 },
        },
        Waist = {
            ...
            { name = "Primal Mooncloth Belt",              source = "Tailoring (Mooncloth)",                    sourceType = "craft", gems = { "yellow", "blue" },       enchant = nil, itemId = 21873 },
        },
        Legs = {
            ...
            { name = "Gilded Trousers of Benediction",     source = "Doomwalker — World Boss",                  sourceType = "drop",  gems = { "yellow", "blue", "blue" }, enchant = nil, itemId = 30727 },
        },
        Feet = {
        ...
        Trinket2 = {
            { name = "Eye of the Dead",                    source = "Sapphiron — Naxxramas",                    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 23047 },
            { name = "Rejuvenating Gem",                   source = "Blackwing Lair",                           sourceType = "drop",  gems = {},                         enchant = nil, itemId = 19395 },
        },
        MainHand = {
        ...
        Relic = {
            { name = "Idol of the Emerald Queen",          source = "Ambassador Hellmaw — Shadow Labyrinth",    sourceType = "drop",  gems = {},                         enchant = nil, itemId = 27886 },
            { name = "Idol of the Raven Goddess",          source = "Vanquish the Raven God",                   sourceType = "quest", gems = {},                         enchant = nil, itemId = 32387 },
            { name = "Harold's Rejuvenating Broach",       source = "The Ultimate Bloodsport",                  sourceType = "quest", gems = {},                         enchant = nil, itemId = 25643 },
        },
    },
    -- =========================================================
    -- PHASE 4 — Zul'Aman
